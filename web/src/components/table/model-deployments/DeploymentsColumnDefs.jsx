...
const STATUS_TAG_CONFIG = {
  running: {
    color: 'green',
    labelKey: '运行中',
    icon: <FaPlay size={12} className='text-[rgb(22,163,74)]' />,
  },
  deploying: {
    color: 'blue',
    labelKey: '部署中',
  ...
  error: {
    color: 'red',
    labelKey: '错误',
    icon: <FaExclamationCircle size={12} className='text-[rgb(239,68,68)]' />,
  },
  failed: {
    color: 'red',
    labelKey: '失败',
  ...
  destroyed: {
    color: 'red',
    labelKey: '已销毁',
    icon: <FaBan size={12} className='text-[rgb(239,68,68)]' />,
  },
  completed: {
    color: 'green',
    labelKey: '已完成',
    icon: <FaCheckCircle size={12} className='text-[rgb(22,163,74)]' />,
  },
...
const renderResourceConfig = (resource, t) => {
  ...
  return (
    <div className='flex flex-col gap-1'>
      ...
      {memory && (
        <div className='flex items-center gap-1 text-xs'>
          <FaMemory className='text-[rgb(34,197,94)]' />
          <span>内存: {memory}</span>
        </div>
      )}
      {gpu && (
...
export const getDeploymentsColumns = ({
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record) => (
        <div className='flex items-center gap-2'>
          <div className='flex items-center gap-1 px-2 py-1 bg-[rgba(34,197,94,0.08)] border border-green-200 rounded-md'>
            <FaServer className='text-[rgb(22,163,74)] text-xs' />
    ...
    },
    {
      ...
      width: 150,
      render: (text) => (
        <span className='text-sm text-semi-color-text-1'>{timestamp2string(text)}</span>
      ),
    },
    {
      title: t('操作'),
