  ...
  return (
    ...
    >
      <div className='flex flex-col h-full max-h-[600px]'>
              ...
              <div className='flex flex-col gap-3'>
                ...
                {containerDetailsLoading ? (
                  ...
                  <div className='grid gap-4 md:grid-cols-2 text-sm'>
                    ...
                    <div className='flex items-center gap-2'>
                      <FaClock className='text-[rgb(249,115,22)]' />
                    ...
                    <div className='flex items-center gap-2'>
                      <FaInfoCircle className='text-[rgb(34,197,94)]' />
                ...
                {containerDetails?.events &&
                  containerDetails.events.length > 0 && (
                    <div className='bg-semi-color-fill-0 rounded-lg p-3'>
                      <Text size='small' type='secondary'>
                        {t('最近事件')}
                      </Text>
        ...
        {/* Log Content */}
        <div className='flex-1 flex flex-col border rounded-lg bg-semi-color-fill-0 overflow-hidden'>
          <div
            ref={logContainerRef}
            className='flex-1 overflow-y-auto bg-semi-color-bg-0'
