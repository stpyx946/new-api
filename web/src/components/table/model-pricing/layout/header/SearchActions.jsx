    ...
    return (
      <div className='flex items-center gap-2 w-full'>
        ...
        <Button
          ...
          className='!bg-semi-color-primary-light-default hover:!bg-semi-color-primary !text-white disabled:!bg-semi-color-fill-1 disabled:!text-semi-color-text-2'
        >
          {t('复制')}
        </Button>
          ...
          <>
            ...
            {supportsCurrencyDisplay && (
              <div className='flex items-center gap-2'>
                <span className='text-sm text-semi-color-text-1'>{t('充值价格显示')}</span>
                <Switch
            ...
            {/* 显示倍率开关 */}
            <div className='flex items-center gap-2'>
              <span className='text-sm text-semi-color-text-1'>{t('倍率')}</span>
