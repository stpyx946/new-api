...
const AccountManagement = ({
  ...
  const renderAccountInfo = (accountId, label) => {
    if (!accountId || accountId === '') {
      return <span className='text-semi-color-text-2'>{t('未绑定')}</span>;
    }
    ...
    const popContent = (
      <div className='text-xs p-2'>
        ...
        {label ? (
          <div className='mt-1 text-[11px] text-semi-color-text-2'>{label}</div>
        ) : null}
      </div>
    );
    ...
    return (
      <Popover content={popContent} position='top' trigger='hover'>
        <span className='block max-w-full truncate text-semi-color-text-1 hover:text-semi-color-primary cursor-pointer'>
          {accountId}
        </span>
      </Popover>
    );
          ...
          <div className='py-4'>
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
              ...
              <Modal
                ...
                footer={null}
              >
                <div className='my-3 text-sm text-semi-color-text-1'>
                  ...
                  <div className='flex flex-col sm:flex-row items-start sm:justify-between gap-4'>
                    <div className='flex items-start w-full sm:w-auto'>
                      ...
                      <div>
                        ...
                        <div className='mt-2 text-xs text-semi-color-text-2 space-y-1'>
                          <div>
