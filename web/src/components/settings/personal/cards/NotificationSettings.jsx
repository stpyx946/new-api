              ...
              <div className='py-4'>
                ...
                {notificationSettings.warningType === 'bark' && (
                  <>
                    ...
                    <div className='mt-3 p-4 bg-semi-color-fill-0/50 rounded-xl'>
                      <div className='text-sm text-semi-color-text-1 mb-3'>
                        <strong>{t('模板示例')}</strong>
                      </div>
                      <div className='text-xs text-semi-color-text-1 font-mono bg-semi-color-bg-0 p-3 rounded-lg shadow-sm mb-4'>
                        https://api.day.app/yourkey/{'{{title}}'}/
                        {'{{content}}'}?sound=alarm&group=quota
                      </div>
                      <div className='text-xs text-semi-color-text-2 space-y-2'>
                        <div>
                          • <strong>{'title'}:</strong> {t('通知标题')}
                        </div>
                        <div>
                        ...
                        <div className='mt-3 pt-3 border-t border-semi-color-border'>
                  ...
                  >
                    {sectionConfigs.map((section) => (
                      <div key={section.key} className='mb-6'>
                        ...
                        >
                          <div>
                            <div className='font-semibold text-base text-semi-color-text-0 mb-1'>
                              {section.title}
                            </div>
                            <Typography.Text
                              type='secondary'
                        ...
                        <Row gutter={[12, 12]}>
                          {section.modules
                            ...
                            .map((module) => (
                              ...
                              >
                                <Card
                                  className={`!rounded-xl border border-semi-color-border hover:border-blue-300 transition-all duration-200 ${
                                ...
                                >
                                  <div className='flex justify-between items-center h-full'>
                                    <div className='flex-1 text-left'>
                                      <div className='font-semibold text-sm text-semi-color-text-0 mb-1'>
                                        {module.title}
                                      </div>
                                      <Typography.Text
                                        type='secondary'
